...
# constants
SOURCE_DIR = Path("/usr/local/airflow/Data/staged/Olympic_Event_Results_Files")
ARCHIVE_DIR = Path("/usr/local/airflow/Data/archieve/Olympic_Event_Results_Files_archieve")
BATCH_SIZE = 5
POSTGRES_CONN_ID= 'postgres_initial'

with DAG(
    dag_id= "olympic_event_results_dag",
    ...
    def load_to_db(tuple_data):
        ...
        try:
            ...
            cursor.executemany("""
                INSERT INTO bronze.Olympic_Event_Results (
